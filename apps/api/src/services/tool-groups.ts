...
export const TOOL_GROUPS = [
  ...
  { id: 'ave_data', name: 'AVE Data', description: 'Crypto Market Data', tools: ['getCryptoPrices', 'searchCoins'] },
  { id: 'grok', name: 'Grok (xAI)', description: 'Social Sentiment', tools: ['analyzeSocialSentiment'] },
  { id: 'firecrawl', name: 'Firecrawl', description: 'Governance Scraping', tools: ['getGovernance'] },
] as const;

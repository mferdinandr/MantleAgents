...
function FxHero() {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: 'Executes stablecoin swaps via automated DEX aggregation across 15+ pairs — USDm, EURm, BRLm, JPYm, and more.',
      tags: ['DEX Aggregation', '15+ pairs'],
    },
  ];
    ...
    >
      <div className="text-center">
        ...
        <p className="mx-auto mt-2 max-w-md text-sm text-muted-foreground leading-relaxed">
          Let your agent trade stablecoin pairs autonomously via automated DEX aggregation.
          AI-driven analysis, configurable risk guardrails, and 24/7 execution.
        </p>
      </div>
    ...
    return (
        <div className="space-y-6">
             <div className="text-center">
                ...
                Autonomous FX stablecoin trading — powered by automated DEX aggregation
                </p>
            </div>

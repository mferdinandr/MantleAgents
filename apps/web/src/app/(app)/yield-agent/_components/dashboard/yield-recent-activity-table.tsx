        ...
        <div className="flex items-center gap-3">
          <div className="flex overflow-hidden rounded-none border-2 border-gb-dark text-xs">
            ...
            <button
              ...
              className={cn("px-3 py-1 transition-colors hover:bg-gb-dark/50", filter === 'deposits' ? "bg-gb-dark font-medium text-gb-light" : "text-gb-mid")}
            >
              Deposits
            </button>
            <div className="w-px bg-gb-dark" />
            <button
              ...
              className={cn("px-3 py-1 transition-colors hover:bg-gb-dark/50", filter === 'analysis' ? "bg-gb-dark font-medium text-gb-light" : "text-gb-mid")}
            >
              Analysis
            </button>
          </div>

...
export function YieldRewardsSection() {
  ...
  if (isLoading) {
    return (
      <div>
        <h3 className="mb-3 text-sm font-semibold text-gb-light">Claimable Rewards</h3>
        <Card>
      ...
      <div>
        ...
        <Card className="border-dashed border-gb-dark bg-gb-deep">
          <CardContent className="flex flex-col items-center justify-center py-8 text-center">
            <Coins className="mb-3 size-6 text-gb-mid/50" />
  ...
  return (
    <div>
      ...
      <Card className="border-gb-dark bg-gb-deep">
        <CardContent className="divide-y divide-gb-dark/50 p-0">
          {claimable.map((reward) => (
            ...
            >
              <div className="flex items-center gap-2">
                <Coins className="size-4 text-gb-accent" />
                <span className="text-sm font-medium text-gb-light">
                  {reward.token.symbol}
                </span>
              </div>
              <div className="text-right">
                <p className="text-sm font-medium text-gb-light">
                  {parseFloat(reward.claimableAmount).toFixed(4)}
                </p>
                <p className="text-[11px] text-gb-mid">

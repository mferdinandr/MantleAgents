          ...
          <div className="space-y-4 max-w-xs">
            ...
            <div className="pt-4 flex items-center gap-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 border-2 border-gb-dark bg-gb-deep px-3 py-1.5 font-vt323 text-base text-gb-accent uppercase transition-colors hover:bg-gb-dark"
              >
                Powered by AI
              </a>
            </div>
            ...
            <div className="pt-4 text-xs text-muted-foreground">
              <p>Multi-chain &middot; BSC · Solana · ETH · Base</p>
            </div>
          </div>
